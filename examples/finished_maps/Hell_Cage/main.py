...
# Map Name
MAP_NAME = "Hell Cage v2.1"                      # Can be multiple words --- name of the Map in the Race Locale Menu
MAP_FILENAME = "hell_cage_v2pt1"                     # One word (no spaces)  --- name of the .AR file and the folder in the SHOP folder
...
set_facades = False             # Change to "True" if you want FACADES
set_physics = True              # Change to "True" if you want PHYSICS (custom)
set_animations = False           # Change to "True" if you want ANIMATIONS (plane and eltrain)
...
# Minimap
set_minimap = True             # Initially set to "False" to save performance. Change to "True" if you want a MINIMAP (defaults to "False" when Blender is running)                              
...
# AI
set_ai_streets = False           # Change to "True" if you want AI streets
